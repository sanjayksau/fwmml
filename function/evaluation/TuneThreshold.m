...
% data with one evaluation metric
    ...
    %%Sanjay: For purpose of tuning, let's use 1-0 as Y values instead of
    %%-1 and 1 to keep the changes in evaluation system minimum.
    target(target == -1) = 0; %This will make sure the existing metric eval works hopefully.
